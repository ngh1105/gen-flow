    ...
    <div className="glass-card w-[260px]">
      ...
      <div className="px-4 py-3 space-y-2">
        <p className="text-[11px] text-muted leading-relaxed">
          ...
          <code className="text-foreground/80 text-[10px]">DynArray[T]</code>
        </p>
        <div className="space-y-1.5">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-none bg-surface border border-border">
            <span className="text-[10px] text-foreground/70 font-mono">.append()</span>
            <span className="text-[10px] text-muted">add item</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-none bg-surface border border-border">
            <span className="text-[10px] text-foreground/70 font-mono">.pop() .clear()</span>
